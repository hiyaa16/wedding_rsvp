...
  return (
    <div className="relative"> {/* Added 'relative' to the outer div */}
      <div // This div will act as the full-screen background
        style={{
...
        }}
      >
        {/* Black Overlay: z-10 is higher than background but lower than content */}
        <div className="absolute inset-0 bg-black/50 z-10"></div>
      </div>

      {/* Content Section: Use z-20 to ensure it's above the background and overlay */}
...
      {/* Modal / Lightbox for big preview (z-50, which is highest) */}
      {showModal && (
        <div 
